...
@Entity
@Table(name = "wavestore_guitar_combo_amp")
public class GuitarComboAmp implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "id_guitar_combo_amp", unique = true, nullable = false)
	private int id;
	...
	public void setSpeakerSize(String speakerSize) {
